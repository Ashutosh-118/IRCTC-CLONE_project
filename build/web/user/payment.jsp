...
<html>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="adminHome.jsp" style="margin-left:170px;">Home</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="add_Train.jsp" style="margin-left:170px;">Add Train </a>
        </li>
        <li class="nav-item">

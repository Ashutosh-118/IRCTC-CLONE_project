...
padding-left: 0;
    ...
    <body>
        <!--navbar-->
         ...
         <!--navbar ends-->
            <!--login form-->
            <div style="background-image:url(images/bg3.jpg); background-size:cover; image-repeat:no-repeat;">
            <div class="card shadow login-card p-4 mt-5"  style="height:400px; width:500px; margin:auto; background-color:pink;">
